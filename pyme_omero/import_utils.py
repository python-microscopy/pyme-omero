...
# ripped and modified slightly from https://gitlab.com/openmicroscopy/incubator/omero-python-importer/-/blob/master/import.py
# see https://forum.image.sc/t/automated-uploader-to-omero-in-python/38290/2
